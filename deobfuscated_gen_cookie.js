...
bmak = bmak && bmak.hasOwnProperty("ver") && bmak.hasOwnProperty("sed") ? bmak : {
    ...
    cma: function (t, a) {
        try {
            ...
            1 == a ? bmak.mme_cnt++ : bmak.mduce_cnt++,
                bmak.me_cnt++,
                bmak.js_post && 3 == a && (bmak.aj_type = 1,
                    bmak.bpd(),
                    bmak.pd(!0),
                    bmak.ce_js_post = 1)
        } catch (t) {}
    ...
    cpa: function (t, a) {
        try {
            ...
            1 == a ? bmak.pme_cnt++ : bmak.pduce_cnt++,
                bmak.pe_cnt++,
                bmak.js_post && 3 == a && e && (bmak.aj_type = 2,
                    bmak.bpd(),
                    bmak.pd(!0),
                    bmak.ce_js_post = 1)
        } catch (t) {}
    ...
    gf: function (t) {
        var a;
        if (a = null == t ? document.activeElement : t,
        ...
        try {
            ...
            if (bmak.ke_cnt < bmak.ke_cnt_lmt && e) {
                ...
                m && n && (n = 0 != m && 0 != n && m != n ? -1 : 0 != n ? n : m),
                    ...
                    k != bmak.prevfid ? (bmak.fidcnt = 0,
                        bmak.prevfid = k) : bmak.fidcnt = bmak.fidcnt + 1;
                if (0 == bmak.isIgn(n)) {
            ...
            o && e && bmak.ke_cnt++,
                !bmak.js_post || 1 != a || 13 != n && 9 != n || (bmak.aj_type = 3,
                    bmak.bpd(),
                    bmak.pd(!0),
                    bmak.ce_js_post = 1)
        } catch (t) {}
    ...
    cta: function (t, a) {
        try {
            ...
            1 == a ? bmak.tme_cnt++ : bmak.tduce_cnt++,
                bmak.te_cnt++,
                bmak.js_post && 2 == a && bmak.aj_indx_tact < bmak.aj_lmt_tact && (bmak.aj_type = 5,
                    bmak.bpd(),
                    bmak.pd(!0),
                    bmak.ce_js_post = 1,
                    bmak.aj_indx_tact++)
        ...
        try {
            if (bmak.dme_cnt < bmak.dme_cnt_lmt && bmak.dma_throttle < 2 && t) {
                var a = bmak.get_cf_date() - bmak.start_ts,
                    ...
                    n = -1,
                    o = -1;
                t.acceleration && (e = bmak.getFloatVal(t.acceleration.x),
                    n = bmak.getFloatVal(t.acceleration.y),
                    o = bmak.getFloatVal(t.acceleration.z));
                var m = -1,
                    r = -1,
                    i = -1;
                t.accelerationIncludingGravity && (m = bmak.getFloatVal(t.accelerationIncludingGravity.x),
                    r = bmak.getFloatVal(t.accelerationIncludingGravity.y),
                    i = bmak.getFloatVal(t.accelerationIncludingGravity.z));
                var c = -1,
                    b = -1,
                    d = 1;
                t.rotationRate && (c = bmak.getFloatVal(t.rotationRate.alpha),
    ...
    form_submit: function () {
        try {
            if (bmak.bpd(),
                0 == bmak.sdfn.length) {
                if (document.getElementById("bm-telemetry") && (document.getElementById("bm-telemetry").value = bmak.sensor_data),
    ...
    gck: function () {
        ...
        return bmak.set_cookie(bmak.ckie, t + "_" + bmak.ab(t)),
            t
    },
    ...
    build_pua: function () {
        try {
            navigator.userAgentData.getHighEntropyValues(["architecture", "model", "platform", "platformVersion", "uaFullVersion", "bitness"]).then(function (t) {
                ...
                a.push("Mozilla/5.0 (");
                var e = [];
                e.push(t.platform, t.platformVersion, t.architecture, t.bitness, t.model),
                    a.push(e.join(";") + ")"),
                    a.push(" AppleWebKit/537.36 (KHTML, like Gecko) Chrome/"),
                    a.push(t.uaFullVersion),
                    navigator.userAgentData.mobile && a.push(" Mobile"),
                    a.push(" Safari/537.36"),
                    bmak.pua = a.join("")
            })
        } catch (t) {
            bmak.pua = ""
    ...
    isChrome: function () {
        try {
            if (void 0 !== navigator.userAgentData.brands)
    ...
    bpd: function () {
        ...
        try {
            ...
            bmak.firstLoad ? bmak.np() : bmak.csh(),
                !bmak.hbCalc && (0 == bmak.js_post || bmak.aj_indx > 0) && (setTimeout(bmak.fm, 4e3),
                    setTimeout(bmak.wgl, 4e3),
                    bmak.hbCalc = !0);
            var E = "";
            ...
            void 0 !== navigator.userAgentData && bmak.isChrome() && bmak.build_pua(),
                bmak.sensor_data = bmak.ver + "-1,2,-94,-100," + n + "-1,2,-94,-131," + bmak.pua + "-1,2,-94,-101," + i + "-1,2,-94,-105," + bmak.informinfo + "-1,2,-94,-102," + c + "-1,2,-94,-108," + bmak.kact + "-1,2,-94,-110," + bmak.mact + "-1,2,-94,-117," + bmak.tact + "-1,2,-94,-111," + bmak.doact + "-1,2,-94,-109," + bmak.dmact + "-1,2,-94,-114," + bmak.pact + "-1,2,-94,-103," + bmak.vcact + "-1,2,-94,-112," + b + "-1,2,-94,-115," + w + "-1,2,-94,-106," + d,
                bmak.sensor_data = bmak.sensor_data + "-1,2,-94,-119," + bmak.mr + "-1,2,-94,-122," + S + "-1,2,-94,-123," + A + "-1,2,-94,-124," + B + "-1,2,-94,-126," + x + "-1,2,-94,-127," + bmak.nav_perm;
    ...
    encode: function (t) {
        if ("undefined" != typeof btoa)
            return btoa(t);
        for (var a, e, n, o, m, r, i, c = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", b = "", d = 3 * Math.floor(t.length / 3), s = 0; s < d; s += 3)
            a = bmak.gb(t, s),
            e = bmak.gb(t, s + 1),
            n = bmak.gb(t, s + 2),
            o = a >> 2,
        ...
        return t.length % 3 == 1 && (a = bmak.gb(t, s),
                o = a >> 2,
                m = (3 & a) << 4,
                b = b + c.charAt(o) + c.charAt(m) + "=="),
            t.length % 3 == 2 && (a = bmak.gb(t, s),
                e = bmak.gb(t, s + 1),
                o = a >> 2,
                m = ((3 & a) << 4) + (e >> 4),
                r = (15 & e) << 2,
    ...
    call_gp: function () {
        var t;
        void 0 !== window.XMLHttpRequest ? t = new XMLHttpRequest : void 0 !== window.XDomainRequest ? (t = new XDomainRequest,
                t.onload = function () {
                    this.readyState = 4,
    ...
    pd: function (t) {
        bmak.check_stop_protocol() || bmak.check_ipr_signals() ? (bmak.apicall_bm(bmak.cf_url, t, bmak.patp),
        ...
        if (bmak.ipr)
            try {
                t = Date.now ? Date.now() : +new Date,
                    t = bmak.pi(t / 1e3) - bmak.get_heartbeat_timestamp()
            } catch (t) {}
        return t > 0
    },
    get_heartbeat_timestamp: function () {
        ...
        if (!1 !== a)
            try {
                ...
                if (e.length > 5) {
                    var n = bmak.pi(e[5]);
                    n = isNaN(n) || -1 == n ? Number.MAX_VALUE : n,
                        t = n
                }
            } catch (t) {}
        return t
                ...
                if (e.length >= 5) {
                    ...
                    if (m.length > 0)
                        for (var r = 0; r < m.length; r++) {
                            var i = m[r],
                                c = i.split("-");
                            if (1 == c.length && "0" == c[0] && (bmak.pdet = !1),
                                c.length >= 5) {
                                var b = bmak.pi(c[0]),
                                    d = c[1],
                                    s = bmak.pi(c[2]),
    ...
    mn_get_new_challenge_params: function (t) {
        ...
        if (null != t)
            for (var o = 0; o < t.length; o++) {
                var m = t[o];
                if (m.length > 0) {
                    for (var r = m[0], i = bmak.mn_abck + bmak.start_ts + m[2], c = (m[3],
                            m[6]), b = 0; b < bmak.mn_lcl && (1 == r && bmak.mn_lc[b] != i); b++)
                    ;
                    b == bmak.mn_lcl && (a = o,
                        2 == c && (e = o),
                        3 == c && (n = o))
    ...
    mn_s: function (t) {
        ...
        for (var h = 0; h < l; h++) {
            for (var v, g = new Array(64), w = e, y = n, E = o, S = m, C = r, v = i, A = c, B = b, _ = 0; _ < 64; _++) {
                var x, M, j, L, P, T;
                _ < 16 ? g[_] = u[h][_] : (x = bmak.rotate_right(g[_ - 15], 7) ^ bmak.rotate_right(g[_ - 15], 18) ^ g[_ - 15] >>> 3,
                        M = bmak.rotate_right(g[_ - 2], 17) ^ bmak.rotate_right(g[_ - 2], 19) ^ g[_ - 2] >>> 10,
                        g[_] = g[_ - 16] + x + g[_ - 7] + M),
                    M = bmak.rotate_right(C, 6) ^ bmak.rotate_right(C, 11) ^ bmak.rotate_right(C, 25),
                    j = C & v ^ ~C & A,
                    L = B + M + j + a[_] + g[_],
                    x = bmak.rotate_right(w, 2) ^ bmak.rotate_right(w, 13) ^ bmak.rotate_right(w, 22),
                    P = w & y ^ w & E ^ y & E,
                    T = x + P,
                    B = A,
                    A = v,
    ...
    mn_w: function () {
        try {
            ...
            bmak.mn_mc_indx += 1,
                bmak.mn_mc_indx < bmak.mn_mc_lmt ? setTimeout(bmak.mn_w, e) : (bmak.mn_mc_indx = 0,
        ...
        _setBm: function (t) {
            bmak.bm = t,
                bmak.bm ? (bmak.cf_url = (bmak.fsp ? "https:" : document.location.protocol) + "//" + document.location.hostname + "/_bm/_data",
                    bmak.js_post = !0) : bmak.params_url = (bmak.fsp ? "https:" : document.location.protocol) + "//" + document.location.hostname + "/get_params"
        },
        _setAu: function (t) {
    ...
    applyFunc: function () {
        ...
        for (t = 0; t < arguments.length; t += 1)
            e = arguments[t];
        a = e.shift(),
            bmak.listFunctions[a] && bmak.listFunctions[a].apply(bmak.listFunctions, e)
    },
    getStateField: function (t) {
        for (var a = "", e = "aeiouy13579", n = 0, o = t.toLowerCase(); n < o.length;)
            e.indexOf(o.charAt(n)) >= 0 || e.indexOf(o.charAt(n + 1)) >= 0 ? a += 1 : a += 0,
            n += 2;
        return a
    }
};
...
if (bmak.sd_debug("<init/>"),
    ...
    var bm_script;
    if (document.currentScript && (bm_script = document.currentScript),
        !bm_script) {
    ...
    if (bm_script.src) {
        var bm_url = bm_script.src,
            ...
            obfus_state_field;
        if (url_split.length >= 4 && (obfus_state_field = bm_url.split("/").slice(-4)[0]),
            obfus_state_field && obfus_state_field.length % 2 == 0) {
            var state_field_str = bmak.getStateField(obfus_state_field);
            state_field_str.length > 3 && (bmak.listFunctions._setFsp("1" == state_field_str.charAt(0)),
                bmak.listFunctions._setBm("1" == state_field_str.charAt(1)),
                bmak.listFunctions._setPowState("1" == state_field_str.charAt(2)),
                bmak.listFunctions._setIpr("1" == state_field_str.charAt(3)),
